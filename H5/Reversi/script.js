...
var askPlayerInfoContainer = function(mode) {
    ...
    startGameButton.innerHTML = "開始遊戲";
...
var preStartGame = function(mode) {
    ...
    return function() {
        ...
        if (mode === "single") {
            ...
            if (takeName1 === "") {
                document.getElementById("player-name").innerHTML = "遊客-1"
                player1Name = "遊客-1";
            } else {
            ...
            if (takeName2 === "") {
                document.getElementById("bot-name").innerHTML = "遊客-2";
                player2Name = "遊客-2";
            } else {
...
var checkWin = function() {
    ...
    if (parseInt(blackScore.innerHTML) > parseInt(whiteScore.innerHTML)) {
        ...
        getWinDisplay.innerHTML = `${player1Name} 獲勝!`;
        startAnimations();
        ...
        getWinDisplay.innerHTML = "平手!!";
        startAnimations();
        // getWinDisplay.style.animation = "fadein 2s";
        // getResultContainer.style.animation ="fadein 2s 2s forwards";
    } else if (parseInt(blackScore.innerHTML) < parseInt(whiteScore.innerHTML)) {

        getWinDisplay.innerHTML = `${player2Name} 獲勝!`;
        startAnimations();
        // getWinDisplay.style.animation = "fadein 2s";
        // getResultContainer.style.animation ="fadein 2s 2s forwards";
    }
...
var initAllBackToMainPage = function() {
    ...
    mode = null;
    stopDualBotMode();
    document.getElementById("player-name").innerHTML = "AI - 白子";
    document.getElementById("bot-name").innerHTML = "AI - 黑子";
    var mainContainer = document.querySelector(".main-container");
    while (mainContainer.firstChild) {
        mainContainer.removeChild(mainContainer.firstChild);
    }
